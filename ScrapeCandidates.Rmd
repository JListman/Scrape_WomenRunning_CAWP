...
Read a blog about it [here](https://medium.com/@jblistman/an-app-to-search-for-women-running-for-office-in-2018-346f5a013ec9)
...
```{r fix_variable, results = "hide", message=FALSE, warning= FALSE}
