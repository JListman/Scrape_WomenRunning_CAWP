                                     ...
                                     column(10,
                                            ...
                                            p("I created this project to visualize a database maintained by the",
                                              ...
                                              a("a list", 
                                                ...
                                                target = "_blank"),
                                              "of women potentially running for US Congress and State offices. The data are current as of 4/2/18."),
                                            p("You can read more about", a("how", href = "https://jenny-listman.netlify.com/blog/scraping-the-cawp-site-to-make-a-shiny-app-to-search-for-women-running-for-office/", target = "_blank"),
                                            ...
                                            "or read more about my work on my", 
